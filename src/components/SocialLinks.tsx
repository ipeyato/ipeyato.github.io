const socialLinks = [
  ...
  {
    name: 'Facebook',
    url: 'https://facebook.com/ato.ipey/',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5">
...
export default function SocialLinks() {
  return (
    <div className="hidden lg:flex fixed bottom-0 left-10 flex-col items-center gap-5 z-10">
      ...
      <div className="w-px h-24 bg-slate mt-1" />
    </div>
  )
}
